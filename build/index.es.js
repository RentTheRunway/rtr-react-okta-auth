import React, { useState, createContext, useContext as useContext$1, useEffect, Component } from 'react';
import { Route as Route$1 } from 'react-router-dom';
...
function useAuthContextState() {
    ...
    var _c = useState(""), userDisplayName = _c[0], setUserDisplayName = _c[1];
    var _d = useState(false), isAuthenticated = _d[0], setIsAuthenticated = _d[1];
    var _e = useState(null), auth = _e[0], setAuth = _e[1];
    return {
        groups: groups,
        user: user,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, auth.logout(redirectTo)];
                    case 1:
                        _a.sent();
                        clearAfterLogout();
                        return [2 /*return*/];
    ...
    function _reAuthorize(args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        setAuth(args.auth);
                        return [4 /*yield*/, tryAuth(args.auth)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    function tryAuth(auth) {
        return __awaiter(this, void 0, void 0, function () {
            var isAuth, user_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, auth.isAuthenticated()];
                    case 1:
                        isAuth = _a.sent();
                        if (!(isAuthenticated !== isAuth)) return [3 /*break*/, 4];
                    ...
                    case 2:
                        user_1 = _a.sent();
                        setUser(user_1);
                        setGroups(user_1.groups || []);
                        setUserDisplayName(user_1.given_name + " " + user_1.family_name);
                        return [3 /*break*/, 4];
                    case 3:
                        clearAfterLogout();
                        _a.label = 4;
                    case 4: return [2 /*return*/, isAuth];
                }
            });
        });
    }
...
function getIntersection(_arrayA, _arrayB) {
    var arrayA = _arrayA.map(function (e) { return e.toLowerCase().trim(); });
    var arrayB = _arrayB.map(function (e) { return e.toLowerCase().trim(); });
    var intersection = arrayA.filter(function (e) { return arrayB.includes(e); });
    return intersection;
}
...
var DefaultUnauthorized = function () {
    return (React.createElement("div", { "data-testid": "default-unauthorized" },
        React.createElement("div", { className: "rtr-react-okta-auth-unauthorized" }, "Unauthorized")));
};

var UnAuthenticated = function () {
    var authContext = useContext$1(AuthContext);
    useEffect(function () {
...
var RouteWhenMemberOfAll = function (props) {
    var groups = props.groups, component = props.component, unauthorizedComponent = props.unauthorizedComponent, rest = __rest(props, ["groups", "component", "unauthorizedComponent"]);
    var authContext = useContext$1(AuthContext);
    var isAuthenticated = authContext.isAuthenticated;
    var intersects = hasFullIntersection(groups, authContext.groups);
    var compToRender = isAuthenticated
        ? intersects
            ? props.component
            : !!props.unauthorizedComponent
                ...
                : DefaultUnauthorized
        : UnAuthenticated;
    return React.createElement(Route$1, __assign({}, rest, { component: compToRender }));
};

var RouteWhenMemberOfAny = function (props) {
    var groups = props.groups, component = props.component, unauthorizedComponent = props.unauthorizedComponent, rest = __rest(props, ["groups", "component", "unauthorizedComponent"]);
    var authContext = useContext$1(AuthContext);
    var isAuthenticated = authContext.isAuthenticated;
...
var WhenMemberOfAll = function (props) {
    var authContext = useContext$1(AuthContext);
    if (!authContext.isAuthenticated)
        return null;
...
var WhenMemberOfAny = function (props) {
    var authContext = useContext$1(AuthContext);
    if (!authContext.isAuthenticated)
        return null;
...
var nodeFetch = getCjsExportFromNamespace(lib$1);
...
function fetchRequest(method, url, args) {
  ...
  var fetchPromise = nodePonyfill(url, {
    method: method,
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === undefined ||
      (eq_1(objValue, objectProto$c[key]) && !hasOwnProperty$c.call(object, key))) {
    return srcValue;
  }
  return objValue;
}
...
function template(string, options, guard) {
  ...
  var sourceURL = hasOwnProperty$d.call(options, 'sourceURL')
    ? ('//# sourceURL=' +
  ...
  var variable = hasOwnProperty$d.call(options, 'variable') && options.variable;
  if (!variable) {
    source = 'with (obj) {\n' + source + '\n}\n';
  }
...
(function() {
  ...
  _assignIn = assignIn_1;

  _isArray = isArray_1;

  _isString = isString_1;

  _isFunction = isFunction_1;

  _isNumber = isNumber_1;

  _isObject = isObject_1;
...
storageUtil.getHttpCache = function() {
  return storageBuilder_1(storageUtil.getStorage(), config.CACHE_STORAGE_NAME);
};
...
var storage$1           = serverStorage.storage;
...
function OktaAuthBuilder(args) {
  ...
  sdk.tx.exists._get = function(name) {
    return storage$1.get(name);
  };
}

var proto$1 = OktaAuthBuilder.prototype;

// { username, password, (relayState), (context) }
proto$1.signIn = function (opts) {
  return tx.postToTransaction(this, '/api/v1/authn', opts);
};

builderUtil.addSharedPrototypes(proto$1);

var server = builderUtil.buildOktaAuth(OktaAuthBuilder);
...
var serverIndex = server(serverStorage, fetchRequest_1);

var packageInfo = createCommonjsModule(function (module, exports) {
...
var _oktaAuthJs2 = _interopRequireDefault(serverIndex);



var _packageInfo2 = _interopRequireDefault(packageInfo);
...
var Auth = function () {
  function Auth(config) {
    ...
    var authConfig = (0, lib.buildConfigObject)(config);
    (0, lib.assertIssuer)(authConfig.issuer, testing);
    (0, lib.assertClientId)(authConfig.clientId);
    (0, lib.assertRedirectUri)(authConfig.redirectUri);
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                params = (0, lib.buildConfigObject)(additionalParams);
...
var Security = function (_Component) {
...
exports.default = (0, reactRouter.withRouter)(Security);
});
...
var Secure_1 = createCommonjsModule(function (module, exports) {
...
unwrapExports(Secure_1);

var withAuth_1 = createCommonjsModule(function (module, exports) {
...
var _Secure2 = _interopRequireDefault(Secure_1);
...
unwrapExports(withAuth_1);

var ImplicitCallback = createCommonjsModule(function (module, exports) {
...
var _withAuth2 = _interopRequireDefault(withAuth_1);
...
exports.default = (0, _withAuth2.default)(function (_Component) {
  ...
  (0, _createClass3.default)(ImplicitCallback, [{
    ...
    value: function render() {
      ...
      return this.state.authenticated ? _react2.default.createElement(reactRouter.Redirect, { to: location }) : _react2.default.createElement(
        'p',
        null,
        this.state.error
      );
...
unwrapExports(ImplicitCallback);

var SecureRoute_1 = createCommonjsModule(function (module, exports) {
...
var SecureRoute = function (_Component2) {
  ...
  (0, _createClass3.default)(SecureRoute, [{
    ...
    key: 'render',
    value: function render() {
      return _react2.default.createElement(reactRouter.Route, {
...
var _Security2 = _interopRequireDefault(Security_1);



var _ImplicitCallback2 = _interopRequireDefault(ImplicitCallback);



var _SecureRoute2 = _interopRequireDefault(SecureRoute_1);
...
unwrapExports(dist);
var dist_1 = dist.Auth;
var dist_2 = dist.withAuth;
var dist_3 = dist.Security;
var dist_4 = dist.SecureRoute;
var dist_5 = dist.ImplicitCallback;

function withAuthUpdator(Component, onAuthKnown, onAuthPending) {
    return Updater;
    function Updater(props) {
        var authContextState = useContext$1(AuthContext);
        var _a = useState(false), hasAuthenticatedState = _a[0], setHasAuthenticatedState = _a[1];
        var currentUrl = "" + window.location.origin + window.location.pathname;
        var redirectUri = props.auth._config.redirectUri;
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            onAuthPending();
                            return [4 /*yield*/, authContextState._reAuthorize(props)];
                        case 1:
                            _a.sent();
...
function withAuthAwareness(Component, onAuthKnown, onAuthPending) {
    if (onAuthKnown === void 0) { onAuthKnown = function () { }; }
    if (onAuthPending === void 0) { onAuthPending = function () { }; }
    return dist_2(withAuthUpdator(Component, onAuthKnown, onAuthPending));
}

var WhenHasClaim = function (props) {
    var authContext = useContext$1(AuthContext);
    if (!authContext.isAuthenticated)
        return null;
...
var WhenHasAnyClaims = function (props) {
    var authContext = useContext$1(AuthContext);
    if (!authContext.isAuthenticated)
        return null;
...
var WhenHasAllClaims = function (props) {
    var authContext = useContext$1(AuthContext);
    if (!authContext.isAuthenticated)
        return null;
...
var RouteWhenHasAnyClaims = function (props) {
    var claims = props.claims, component = props.component, unauthorizedComponent = props.unauthorizedComponent, rest = __rest(props, ["claims", "component", "unauthorizedComponent"]);
    var authContext = useContext$1(AuthContext);
    var isAuthenticated = authContext.isAuthenticated;
...
var RouteWhenHasClaim = function (props) {
    return React.createElement(RouteWhenHasAnyClaims, __assign({}, props, { claims: [props.claim] }));
};

var RouteWhenHasAllClaims = function (props) {
    var claims = props.claims, component = props.component, unauthorizedComponent = props.unauthorizedComponent, rest = __rest(props, ["claims", "component", "unauthorizedComponent"]);
    var authContext = useContext$1(AuthContext);
    var isAuthenticated = authContext.isAuthenticated;
...
export { AuthContext, AuthContextProvider, RouteWhenHasAllClaims, RouteWhenHasAnyClaims, RouteWhenHasClaim, RouteWhenMemberOfAll, RouteWhenMemberOfAny, WhenHasAllClaims, WhenHasAnyClaims, WhenHasClaim, WhenMemberOfAll, WhenMemberOfAny, useAuthContextState, withAuthAwareness };
