...
function useAuthContextState() {
    ...
    var _c = React.useState(""), userDisplayName = _c[0], setUserDisplayName = _c[1];
    var _d = React.useState(false), isAuthenticated = _d[0], setIsAuthenticated = _d[1];
    var _e = React.useState(null), auth = _e[0], setAuth = _e[1];
    return {
        groups: groups,
        user: user,
...
var DefaultUnauthorized = function () {
    return (React__default.createElement("div", { "data-testid": "default-unauthorized" },
        React__default.createElement("div", { className: "rtr-react-okta-auth-unauthorized" }, "Unauthorized")));
};
    ...
    var compToRender = isAuthenticated
        ? intersects
            ...
            : !!props.unauthorizedComponent
                ...
                : DefaultUnauthorized
        : UnAuthenticated;
    return React__default.createElement(reactRouterDom.Route, __assign({}, rest, { component: compToRender }));
};
...
function withAuthUpdator(Component, onAuthKnown, onAuthPending) {
    ...
    function Updater(props) {
        ...
        var _a = React.useState(false), hasAuthenticatedState = _a[0], setHasAuthenticatedState = _a[1];
        var currentUrl = "" + window.location.origin + window.location.pathname;
        var redirectUri = props.auth._config.redirectUri;
        var shouldRun = (currentUrl !== redirectUri);
        React.useEffect(effect, [shouldRun]);
...
var RouteWhenHasClaim = function (props) {
    return React__default.createElement(RouteWhenHasAnyClaims, __assign({}, props, { claims: [props.claim] }));
};
