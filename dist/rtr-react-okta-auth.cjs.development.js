...
var oktaReact = require('@okta/okta-react');
...
var RouteWhenMemberOfAll = function RouteWhenMemberOfAll(props) {
  ...
  var isAuthenticated = oktaReact.useOktaAuth().authState.isAuthenticated;
...
function withAuthUpdator(Component, onAuthKnown, onAuthPending) {
  ...
  function Updater(props) {
    var _useOktaAuth = oktaReact.useOktaAuth(),
    ...
    var authContextState = React.useContext(AuthContext);
    var authPending = authState && authState.isPending;
    var authKnown = authState && !authState.isPending;
    React.useEffect(onAuthStateChange, [authKnown]);
...
function withAuthAwareness(Component, onAuthKnown, onAuthPending) {
  ...
  return oktaReact.withOktaAuth(withAuthUpdator(Component, onAuthKnown, onAuthPending));
}
